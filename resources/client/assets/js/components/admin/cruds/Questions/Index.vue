<template>
  <section class="content-wrapper" style="min-height: 960px;">
    <section class="content-header">
      <h1>{{questionType=='pre'?'Pre':(questionType=='post'?'Post':'All')}} Questions</h1>
    </section>
...
export default {
  data() {
    return {
      ...
      questionType: this.$route.params.type
    };
  },
  created() {
    this.$root.relationships = this.relationships;
    this.setPageType(this.$route.params.type);
