            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <router-link v-if="$can('test_view')" :to="{ name: 'tests.show', params: { id: testId }}" class="btn btn-default btn-sm">
                            <span class="glyphicon glyphicon-chevron-left"></span> Back to Test
                        </router-link>
                    </div>
                    <div class="box-body">
                        <div class="btn-group">
                            <router-link v-if="$can(xprops.permission_prefix + 'create')" :to="{ name: xprops.route + '.create', params: { id: testId }}" class="btn btn-success btn-sm">
...
export default {
  ...
  methods: {
    ...mapActions("ResultsIndex", ["fetchData", "setQuery", "resetState"])
  }
};
</script>
