        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <router-link
                v-if="$can('test_view')"
                :to="{ name: 'tests.show', params: { id: testId }}"
            ...
            <div class="box-body">
              <div class="btn-group">
                <router-link
                  ...
                  :to="{ name: xprops.route + '.create', params: { id: testId }}"
                  class="btn btn-success btn-sm"
                >
                  <i class="fa fa-plus"></i> Add new
                </router-link>
                <button type="button" class="btn btn-default btn-sm" @click="fetchData(testId)">
...
import DatatableFactorResultCntColumn from "../../dtmodules/DatatableFactorResultCntColumn";
...
export default {
  data() {
    return {
      columns: [
        ...
        {
          title: "Results",
          field: "factor_result_cnt",
          tdComp: DatatableFactorResultCntColumn,
          sortable: true
        },
        {
          title: "Actions",
  ...
  created() {
    ...
    this.fetchData(this.testId);
  },
  destroyed() {
    this.resetState();
  },
  computed: {
    ...mapGetters("FactorsIndex", [
      "data",
      "testinfo",
      "total",
      "loading",
  ...
  watch: {
    "$route.params": function() {
      this.fetchData(this.$route.params.id, this.$route.params.type);
    },
    query: {
      handler(query) {
        this.setQuery(query);
  ...
  methods: {
    ...mapActions("FactorsIndex", ["fetchData", "setQuery", "resetState"])
  }
};
</script>
